...
6. 在“询盘管理 > 询盘设置”中配置通知邮箱。默认包含 WordPress 管理员邮箱和 leadtopmediahk@gmail.com，升级时会保留原收件人并自动追加这两个地址。
...
= 1.1.7 =
* 询盘列表增加“重新发送邮件通知”批量操作，可按当前通知邮箱设置重发历史询盘。
...
= 1.1.4 =
* 恢复正式询盘通知的管理员邮箱、原收件人和 leadtopmediahk@gmail.com 配置；测试邮箱不写入正式收件人。

= 1.1.3 =
* 将新询盘通知收件人统一为 leadtopmediahk034@gmail.com。

= 1.1.2 =
* 升级时确保 WordPress 管理员邮箱与 leadtopmediahk@gmail.com 同时保留为通知收件人。

= 1.1.1 =
* 默认并在升级时追加 leadtopmediahk@gmail.com 作为新询盘通知收件人。
* 通知邮件支持直接回复客户邮箱，并在询盘后台显示发送状态。
